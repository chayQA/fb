...
class BasePage:
    ...
    #basepage we have all the common functions for the application
    #genaric function

    #instance function -- 1st argument -->>self
    #for BasePage we have created Object as Driver 
    #self.driver is a instance variable ---f the value of a variable varies from object to object, then such variables are called instance variables.
    ...
    def do_click(self, by_locator):
        #instance method -- self as a argument
        """
